...
public class F1Jms extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ///////////////////////////////////////////////
        //    Click sur les bouton par le joueur     //
        ///////////////////////////////////////////////
        int indexT;
        ...
        else if(e.getSource()==this.btn_20) { indexT = 20; }
        ...
        ///////////////////////////////////////
        // FIN Gestion des nombre du tableau //
        ///////////////////////////////////////
        ...
        ///////////////////
            ...
            JOptionPane.showMessageDialog(null, "Interdiction de passer ton tour, MARGOULIN!!!");
        }
        ...
        /////////////////////////////////////
        // FIN DU JEU SI LE JOUEUR TERMINE //
        /////////////////////////////////////
        ...
        if (tableau[0] == 0 && tableau[7]  == 0 && tableau[14] == 0 &&
            ...
            JOptionPane.showMessageDialog(null, "Joueur 1 vous avez perdu"
                                     + "\nQuitter le jeu pour recommencer");
        }
        ...
        //////////////////////////////////////////////////
        if (joueur == 2){
            int nbTourOrdi = (int) (Math.random() * 2);
            nbTourOrdi++; // evite le 0 [permet donc d'avoir un nb entre 1&3]
            int cptTour = 0;
            tour = 0;
            joueur = 1;
            
            System.out.println("\n\nL'ordi va jouer : "+nbTourOrdi);
            
            while (cptTour != (nbTourOrdi)) {
                indexT = (int) (Math.random() * 20);
                
                if (indexT != 20) {
                    //bouton chiffre    
                    if (tableau[indexT] == 0) {
                        //l'ordi doit recommencer sauf si :
                        if (tableau[0] == 0 && tableau[7]  == 0 && tableau[14] == 0 &&
                            tableau[1] == 0 && tableau[8]  == 0 && tableau[15] == 0 &&
                            tableau[2] == 0 && tableau[9]  == 0 && tableau[16] == 0 &&
                            tableau[3] == 0 && tableau[10] == 0 && tableau[17] == 0 &&
                        ...
                        // GESTION DE LA COULEUR POUR l'oRDI //
                        switch (indexT) {
                            case 0 : pan0.setBackground(Color.WHITE);  btn_0.enable(false);break;
                            case 1 : pan1.setBackground(Color.WHITE);  btn_1.enable(false);break;
                            case 2 : pan2.setBackground(Color.WHITE);  btn_2.enable(false);break;
                            case 3 : pan3.setBackground(Color.WHITE);  btn_3.enable(false);break;
                            case 4 : pan4.setBackground(Color.WHITE);  btn_4.enable(false);break;
                            case 5 : pan5.setBackground(Color.WHITE);  btn_5.enable(false);break;
                            case 6 : pan6.setBackground(Color.WHITE);  btn_6.enable(false);break;
                            case 7 : pan7.setBackground(Color.WHITE);  btn_7.enable(false);break;
                            case 8 : pan8.setBackground(Color.WHITE);  btn_8.enable(false);break;
                            case 9 : pan9.setBackground(Color.WHITE);  btn_9.enable(false);break;
                            case 10 : pan10.setBackground(Color.WHITE);btn_10.enable(false);break;
                            case 11 : pan11.setBackground(Color.WHITE);btn_11.enable(false);break;
                            case 12 : pan12.setBackground(Color.WHITE);btn_122.enable(false);break;
                            case 13 : pan13.setBackground(Color.WHITE);btn_13.enable(false);break;
                            case 14 : pan14.setBackground(Color.WHITE);btn_14.enable(false);break;
                            case 15 : pan15.setBackground(Color.WHITE);btn_15.enable(false);break;
                            case 16 : pan16.setBackground(Color.WHITE);btn_16.enable(false);break;
                            case 17 : pan17.setBackground(Color.WHITE);btn_17.enable(false);break;
                            case 18 : pan18.setBackground(Color.WHITE);btn_18.enable(false);break;
                            case 19 : pan19.setBackground(Color.WHITE);btn_19.enable(false);break;
                        }///////////////
                        
                        /////////////// GESTION FIN DU JEU ORDI ////////////////
                        if (tableau[0] == 0 && tableau[7]  == 0 && tableau[14] == 0 &&
                            tableau[1] == 0 && tableau[8]  == 0 && tableau[15] == 0 &&
                            tableau[2] == 0 && tableau[9]  == 0 && tableau[16] == 0 &&
                            tableau[3] == 0 && tableau[10] == 0 && tableau[17] == 0 &&
    ...
    public F1Jms() {
        initComponents();
        this.setTitle("Jeu de Nim : Mode 1 joueur simple"); 
    ...
    private void initComponents() {
        ...
        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/refresh.png"))); // NOI18N
        jMenu2.setText("Redémaré le Jeu");
