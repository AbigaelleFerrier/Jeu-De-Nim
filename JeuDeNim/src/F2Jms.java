...
public class F2Jms extends javax.swing.JFrame implements ActionListener {
    ...
    public F2Jms() {
        initComponents();
        this.setTitle("Jeu de Nim : Mode 2 joueur simple"); 
    ...
    private void initComponents() {
        ...
        jMenu6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/refresh.png"))); // NOI18N
        jMenu6.setText("Redémaré le jeu");
